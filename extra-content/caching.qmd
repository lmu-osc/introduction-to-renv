...
A cache is built per each minor version of R you use. For example, if you have used {renv} with R versions 4.3 and 4.4 on your computer, then you will end up with a cache matching each of these R versions. This is an important detail to note for the [Restoring Projects](../about-renv/restoring-a-project.qmd) section of this tutorial, as you may need to rebuild the cache if you upgrade your R version.
