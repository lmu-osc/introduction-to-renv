...
The following examples will guide you through the process of initializing a project with {renv} and then snapshotting the project to capture the packages used in the project. It is **recommended** that you fork the [intro-to-renv-exercises](https://github.com/lmu-osc/introduction-to-renv-exercises/tree/main) repository to your GitHub account and clone it to your local machine to follow along with the examples. This will allow the course facilitators to see your work, provide feedback, and troubleshoot with you as needed.
...
The exercises for initiating and snapshotting a project can be found in the `init-snapshot-exercises` folder of the [intro-to-renv-exercises](https://github.com/lmu-osc/introduction-to-renv-exercises/tree/main) repo.
