...
More to the focus of this tutorial, however, {renv} allows you to create a "snapshot" of your package dependencies in just a handful of steps, summarized below: 
...
The results of this code will be discussed in the next chapter, but, in short, the "snapshot" it creates can be shared with collaborators or used to recreate your working environment at a later date.
