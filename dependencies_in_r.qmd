...
Matching the installed version of R to the required version, however, will tend to be the main problem in most cases. The potential solutions are too expansive to cover in this tutorial, but the most common solution is to use a containerization system like [rig](https://github.com/r-lib/rig) for R projects on your computer, or to use a cloud-based solution like [Binder](https://mybinder.org/) for creating [Docker](https://www.docker.com/) files or [RStudio Cloud](https://rstudio.cloud/). These solutions allow you to create a "container" that contains all the software you need to run your project, and can be shared with collaborators or used to recreate your working environment at a later date.
