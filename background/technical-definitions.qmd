...
installed.packages(priority = c("base", "recommended")) %>%
  ...
  DT::datatable(
    options = list(paging = TRUE, scrollY = "300px", pageLength = 11)
  )
```
...
::: center-larger
![Popular R repositories: Comprehensive R Archive Network (CRAN) and Bioconductor](/assets/img/cran-and-bioconductor.png)
:::
