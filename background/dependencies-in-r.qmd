...
**If you need to change R versions for your projects, we recommend downloading [rig](https://github.com/r-lib/rig). See the [Managing R Versions with `rig`](/extra-content/rig.qmd) chapter for installation and usage instructions.**
:::
