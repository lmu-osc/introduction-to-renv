...
Please *only* read this section! These are not follow-along examples--the practice material is presented in the [Exercises chapter](/exercises/index.qmd).
...
-   `pak::pkg_deps_tree()` for a visual representation of the direct dependencies **and** the recursive dependencies. An example of this will be shown in the [Starting Details](/about-renv/starting-details.qmd) chapter.
:::
...
More recently, the `uv` package and project manager from [Astral](https://docs.astral.sh/uv/) has gained massive momentum due to its overall convenience, and may become the de facto Python management tool in the near future. (For reference, this note was added in September of 2026.)
:::

The next chapter delves into some necessary [Technical Definitions](technical-definitions.qmd) in the R ecosystem, the following chapter will really dive in to the details of [R Package Managers](dependencies-in-r.qmd).
