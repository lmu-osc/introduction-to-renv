...
This page will provide a brief overview of how to get started with the {renv} package. The goal is to provide a quick and easy way to get started with the package, and to provide a brief overview of the package's functionality. This page will be followed by a more detailed explanation of the package's functionality in the [Understanding {renv}](starting_details.html) page.
